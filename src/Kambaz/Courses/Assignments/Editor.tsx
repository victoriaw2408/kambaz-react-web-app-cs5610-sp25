...
export default function AssignmentEditor() {
  ...
  return (
    <div>
            ...
            <li key={assignment._id}>
              <div>
                <FormGroup className="mb-3" controlId="wd-name">
                  ...
                  <FormControl type="text" value={assignment._id} />
                </FormGroup>
      ...
      <Col sm={10}>
        <Form.Control value={assignment.points} />
      </Col>
    </Form.Group>
            ...
            <Card.Body>
              <FormGroup as={Row} className="wd-submission-type" align="left" >
                <Col sm={15}>
                  ...
                  <FormControl type="text" value={assignment.dueDate}  />
              
                   <br />
                  <Row>
                    <Col sm={6}>
                      <FormLabel><strong>Available From</strong></FormLabel>
                      <FormControl value={assignment.availableFrom} />
                    </Col>
                    <Col sm={6}>
                      <FormLabel><strong>Until</strong></FormLabel>
                      <FormControl value={assignment.until} />
                    </Col>
                  </Row>
                </Col>
