...
export default function WorkingWithArrays() {
    ...
    const handleTodoCompletedChange = (e: { target: { checked: any; }; }) => {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <h3>Updating an Item in an Todo</h3>
            ...
            <h3>Updating Description in an Todo</h3>
      ...
      <br /><br /><hr />
      <h3>Updating Completed in an Todo</h3>
